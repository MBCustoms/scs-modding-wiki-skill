...
Special tool for compositing final vertex color from 4 independent layers. Tool can be found inside SCS Tools in Tool Shelf under button named **VColoring**.
